      ...
      <Grid container spacing={3} justifyContent="space-around">
        <Grid item md={6} xs={12} alignItems="center">
          ...
          <FlexBox justifyContent="center" mb={6}>
            ...
            <LazyImage alt={product?.title} width={300} height={300} loading="eager" objectFit="contain" src={product?.images && product?.images[selectedImage]} />
}
          </FlexBox>
            

          <FlexBox overflow="auto">
            { product?.images && product?.images.map((url, ind) => <FlexRowCenter key={ind} width={64} height={64} minWidth={64} bgcolor="white" border="1px solid" borderRadius="10px" ml={ind === 0 ? "auto" : 0} style={{
            cursor: "pointer"
          }} onClick={handleImageClick(ind)} mr={ind === product?.images.length - 1 ? "auto" : "10px"} borderColor={selectedImage === ind ? "primary.main" : "grey.400"}>
